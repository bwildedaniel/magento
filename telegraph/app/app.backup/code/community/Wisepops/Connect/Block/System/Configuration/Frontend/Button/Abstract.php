...
class Wisepops_Connect_Block_System_Configuration_Frontend_Button_Abstract extends Mage_Adminhtml_Block_System_Config_Form_Field {
     ...
     * @var string
     */
    const SIGNUP_URL = 'https://app.wisepops.com/try-it-out/plan/trial/duration/month?website=%s&utm_source=%s&utm_campaign=Magento&utm_medium=Plugin';
    /**
     * @var string
     */
    const SIGNIN_URL = 'https://app.wisepops.com/dashboard#magento?website=%s&utm_source=%s&utm_campaign=Magento&utm_medium=Plugin';
